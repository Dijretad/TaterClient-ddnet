...
MACRO_CONFIG_INT(ClMapTimesMenuFontSize, cl_map_times_menu_font_size, 30, 10, 500, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Font size in map times menu")
...
MACRO_CONFIG_INT(ClMapTimesMenuHeight, cl_map_times_menu_height, 650, 300, 8000, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Height of the map times menu")
