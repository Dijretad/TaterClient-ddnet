...
MACRO_CONFIG_INT(ClMapTimesMenuLineHeight, cl_map_times_menu_line_height, 50, 20, 100, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Height of each line in map times menu")
MACRO_CONFIG_INT(ClMapTimesMenuFontSize, cl_map_times_menu_font_size, 22, 10, 50, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Font size in map times menu")
MACRO_CONFIG_INT(ClMapTimesMenuSpacing, cl_map_times_menu_spacing, 2, 0, 10, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Spacing between lines in map times menu")
MACRO_CONFIG_INT(ClMapTimesMenuWidth, cl_map_times_menu_width, 750, 400, 1200, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Width of the map times menu")
MACRO_CONFIG_INT(ClMapTimesMenuHeight, cl_map_times_menu_height, 500, 300, 800, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Height of the map times menu")
MACRO_CONFIG_INT(ClShowhudMapTimes, cl_showhud_map_times, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Show ingame HUD (Top 5 Map Times)")
